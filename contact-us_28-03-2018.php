          ...
          <div class="col-md-7">
            ...
            <form id="contact_form" name="contact_form" class="form-transparent" action="#" method="post">
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input name="form_email" class="form-control required email" style="color:#555;" type="email" placeholder="Enter Email">
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
					...
					<select name="form_subject" class="form-control required" type="text" placeholder="Select Subject" style="color:#555;">
              ...
              <div class="form-group">
                ...
                <textarea name="form_message" class="form-control required" rows="5" style="color:#555;" placeholder="Enter Message"></textarea>
              </div>
              <div class="form-group">
                ...
                <button type="submit" name="submit" class="btn btn-dark btn-theme-colored btn-flat mr-5">Send your message</button>
                <button type="reset" class="btn btn-default btn-flat btn-theme-colored">Reset</button>
              </div>
			  	<div class="form-group">
					<?php 
						if(isset($_POST['submit'])){
							$to = "playersunnyplayer@gmail.com"; // this is your Email address
                ...
                submitHandler: function(form) {
                  ...
                  $(form).ajaxSubmit({
                    ...
                    success: function(data) {
                      ...
                      setTimeout(function(){ $(form_result_div).fadeOut('slow') }, 1000);
                    }
                  });
                }
              });
